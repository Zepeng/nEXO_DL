...
class AdaptiveFourierNeuralOperator(nn.Module):
    def __init__(self, dim, h=14, w=8):
        ...
        self.num_blocks = 1 #args.fno_blocks
        ...
        self.softshrink = 0 #args.fno_softshrink
...
class Block(nn.Module):
    def __init__(self, dim, mlp_ratio=4., drop=0., drop_path=0., act_layer=nn.GELU, norm_layer=nn.LayerNorm, h=14, w=8, use_fno=False, use_blocks=False):
        ...
        self.filter = AFNO2D(hidden_size=768 , num_blocks=1, sparsity_threshold=0.01, hard_thresholding_fraction=1, hidden_size_factor=1)
            #self.filter = AdaptiveFourierNeuralOperator(dim, h=h, w=w)
        ...
        self.double_skip = True #args.double_skip
...
class AFNONet(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        #args = get_args()
        self.mixing_type = 'afno' #args.mixing_type
...
def test():
    net = AFNONet(img_size=224, patch_size=4, in_chans=2, num_classes=2)
